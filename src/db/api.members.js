...
const members = [
  ...
  },
  {
    ...
    technologies: {
      html: { name: "HTML", lavel: "90" },
      css: { name: "CSS", lavel: "60" },
      bootstrap: { name: "Bootstrap", lavel: "20" },
      javascript: { name: "JavaScript", lavel: "70" },
      react: { name: "React", lavel: "50" },
      git: { name: "GIT", lavel: "60" },
    },
  ...
  },
  {
    ...
    technologies: {
      html: { name: "HTML", lavel: "90" },
      css: { name: "CSS", lavel: "90" },
      bootstrap: { name: "Bootstrap", lavel: "90" },
      javascript: { name: "JavaScript", lavel: "90" },
      react: { name: "React", lavel: "90" },
      php: { name: "PHP", level: "90" },
      git: { name: "GIT", lavel: "90" },
    },
    socialLinks: {
      facebook: "https://www.facebook.com/",
      github: "https://github.com/",
  ...
  },
  {
    ...
    technologies: {
      html: { name: "HTML", lavel: "50" },
      css: { name: "CSS", lavel: "30" },
      javascript: { name: "JavaScript", lavel: "60" },
      react: { name: "React", lavel: "40" },
      git: { name: "GIT", lavel: "50" },
    },
    socialLinks: {
      facebook: "https://www.facebook.com/",
      github: "https://github.com/",
  ...
  },
  {
    ...
    technologies: {
      ...
      javascript: { name: "JavaScript", lavel: "60" },
      react: { name: "React", lavel: "40" },
      php: { name: "PHP", level: "40" },
      git: { name: "GIT", lavel: "10" },
    },
    socialLinks: {
      facebook: "https://www.facebook.com/",
      github: "https://github.com/",
  ...
  },
  {
    ...
    technologies: {
      html: { name: "HTML", lavel: "40" },
      css: { name: "CSS", lavel: "30" },
      bootstrap: { name: "Bootstrap", lavel: "10" },
      javascript: { name: "JavaScript", lavel: "50" },
      react: { name: "React", lavel: "20" },
      node: { name: "Node.js", lavel: "5" },
      webpack: { name: "Webpack", level: "10" },
      git: { name: "GIT", lavel: "10" },
    },
    socialLinks: {
      facebook: "https://www.facebook.com/",
